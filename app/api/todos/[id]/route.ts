...
// 11. Definisikan Tipe Parameter Dinamis (RouteContext)
type RouteContext = {
    params: Promise<{
        id: string;
    }>;
...
// 12. Ekstrak Parameter ID dari URL
export async function GET(request: NextRequest, context: RouteContext) {
    const { id } = await context.params;

    // 13. Ambil Data dan Tangani Skenario Tidak Ditemukan (404)
    try {
        ...
        // 14. Bungkus dan Kirim Respons Sukses (200)
